...
public class MarcadorBaloncesto {
    ...
    public void añadirCanasta(char equipo, int puntos){
       if (puntos == 1 || puntos == 2 || puntos == 3) {
           ...
           throw new IllegalArgumentException("El valor solo puede ser L para local o V para visitante");
       }
    }
    public void reset(){
    ...
    public void guardar(String ruta)throws IOException{
        ...
        printWriter.print(this.nombreLocal+":"+this.puntosLocal+" - "+this.nombreVisitante+":"+this.puntosVisitante);
        printWriter.close();
    }
